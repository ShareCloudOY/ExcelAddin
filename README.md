...
Office Addins ülesanne 1: Create an Excel task pane add-in:

* [Create an Excel task pane add-in](https://docs.microsoft.com/en-us/office/dev/add-ins/tutorials/excel-tutorial)
